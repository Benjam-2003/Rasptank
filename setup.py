...
commands_1 = [
    ...
    "sudo pip3 install adafruit-circuitpython-pca9685", # UPDATED FROM adafruit-python-pca9685
...
try: #fix conflict with onboard Raspberry Pi audio
    ...
    with open("/etc/modprobe.d/snd-blacklist.conf",'w') as file_to_write:
        file_to_write.write("blacklist snd_bcm2711") # CHANGED FROM snd_bcm2835
except:
    pass
try:
